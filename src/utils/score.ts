...
export function calculateScores(answers: Record<string, Record<string, number>>, gender: 'male' | 'female' = 'male'): ScoreResult {
  // Initialize scores for all types based on gender
